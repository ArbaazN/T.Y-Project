...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="cx/urau1iuRUK1qBwMTDgwTqIlvXpVCjiCWJBFlCVWhbOukcnKNaEmvjLBsNaP87ygPg87hQpwCKIt5ukojj/fmYDtCadI5bYu7UM1KSI79CLmoCdM2GwhPJlDDMeXS6SxfBa385/pIZUrhTHQ9q0lTBetAch/NMnxpJxsFR2gZSsmbA+Fqc/sguT3DEt5MabARh5t1rNLj9vqa9CK64Iw==" />
</div>
...
<script type="text/javascript">
    ...
    $sql="SELECT `p_fig` FROM `reg`";
    $tr=$database->safeRetrieve($sql,NULL);        ?>
    template_2=<?php for($i=0;$i<=count($tr);$i++){
        echo $tr[$i]["p_fig"];    ?>;
