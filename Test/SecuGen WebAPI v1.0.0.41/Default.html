...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <p style="margin-left:40px">
                Hamster Pro (HUPx)<br>
                Hamster Pro 20 (HU20)<br>
                Hamster IV (HSDU04P)<br>
                Hamster Plus (HSDU03P)
            </p>
            <p>
                This website provides simple demos that you use with your SecuGen fingerprint reader to perform Fingerprint Scanning, Fingerprint Matching, and Fingerprint Enrollment functions through your web browser.
            </p>
            <p>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <p>
                <b><a href="Enroll.aspx">Enroll </a></b>(multiple fingerprint scanning)
            </p>
        </div>
    </div>
